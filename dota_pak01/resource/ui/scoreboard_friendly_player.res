"Resource/UI/scoreboard_friendly_player.res"
{
	...
	{		
		...
		"UnitHealth"
		{
			...
			"enabled"			"1"
			"horizontal"		"1"
			"image"				"vgui\hud\ui_progressbar_horizontal"
	...
	styles
	{
		PlayerBackground
		{
			render_bg
			{
				0="image_scalable( x0, y0, x1, y1, hud/scoreboard_default_bg, 8, 8, 3, 3, 1, 1 )"
			}		
		}
		...
		PlayerBackground:hover
		{
			render_bg
			{
				0="image_scalable( x0, y0, x1, y1, hud/scoreboard_default_bg_over, 8, 8, 3, 3, 1, 1 )"
			}
		}
		...
		PlayerBackground:active
		{
			render_bg
			{
				0="image_scalable( x0, y0, x1, y1, hud/scoreboard_me_bg, 8, 8, 3, 3, 1, 1 )"
			}
		}
		...
		PlayerBackground:active:hover
		{
			render_bg
			{
				0="image_scalable( x0, y0, x1, y1, hud/scoreboard_me_bg_over, 8, 8, 3, 3, 1, 1 )"
			}
		}
