"Resource/UI/DOTAPlayPanel.res"
{
	...
	styles
	{
		...
		MatchButtonStyle			{ bgcolor=none render_bg	{ 0="image_scale(x0,y0,x1,y1,dashboard/dash_button_large_bg)"		1="image_scale(x0,y0,x1,y1,dashboard/dash_button_large_glyph_match)" }	}
		MatchButtonStyle:hover		{ bgcolor=none render_bg	{ 0="image_scale(x0,y0,x1,y1,dashboard/dash_button_large_bg)"		1="image_scale(x0,y0,x1,y1,dashboard/dash_button_large_glyph_match)" }	}
		MatchButtonStyle:active		{ bgcolor=none render_bg	{ 0="image_scale(x0,y0,x1,y1,dashboard/dash_button_large_bg)"		1="image_scale(x0,y0,x1,y1,dashboard/dash_button_large_glyph_match)" }	}
		MatchButtonStyle:selected	{ bgcolor=none render_bg	{ 0="image_scale(x0,y0,x1,y1,dashboard/dash_button_large_selected)" 1="image_scale(x0,y0,x1,y1,dashboard/dash_button_large_glyph_match)" }	}

		TournamentButtonStyle			{ bgcolor=none render_bg	{ 0="image_scale(x0,y0,x1,y1,dashboard/dash_button_large_bg)"		1="image_scale(x0,y0,x1,y1,dashboard/dash_button_large_glyph_tournament)" }	}
		TournamentButtonStyle:hover		{ bgcolor=none render_bg	{ 0="image_scale(x0,y0,x1,y1,dashboard/dash_button_large_bg)"		1="image_scale(x0,y0,x1,y1,dashboard/dash_button_large_glyph_tournament)" }	}
		TournamentButtonStyle:active	{ bgcolor=none render_bg	{ 0="image_scale(x0,y0,x1,y1,dashboard/dash_button_large_bg)"		1="image_scale(x0,y0,x1,y1,dashboard/dash_button_large_glyph_tournament)" }	}
		TournamentButtonStyle:selected	{ bgcolor=none render_bg	{ 0="image_scale(x0,y0,x1,y1,dashboard/dash_button_large_selected)" 1="image_scale(x0,y0,x1,y1,dashboard/dash_button_large_glyph_tournament)" }	}

		PracticeButtonStyle				{ bgcolor=none render_bg	{ 0="image_scale(x0,y0,x1,y1,dashboard/dash_button_large_bg)"		1="image_scale(x0,y0,x1,y1,dashboard/dash_button_large_glyph_practice)" }	}
		PracticeButtonStyle:hover		{ bgcolor=none render_bg	{ 0="image_scale(x0,y0,x1,y1,dashboard/dash_button_large_bg)"		1="image_scale(x0,y0,x1,y1,dashboard/dash_button_large_glyph_practice)" }	}
		PracticeButtonStyle:active		{ bgcolor=none render_bg	{ 0="image_scale(x0,y0,x1,y1,dashboard/dash_button_large_bg)"		1="image_scale(x0,y0,x1,y1,dashboard/dash_button_large_glyph_practice)" }	}
		PracticeButtonStyle:selected	{ bgcolor=none render_bg	{ 0="image_scale(x0,y0,x1,y1,dashboard/dash_button_large_selected)" 1="image_scale(x0,y0,x1,y1,dashboard/dash_button_large_glyph_practice)" }	}

		TutorialButtonStyle				{ bgcolor=none render_bg	{ 0="image_scale(x0,y0,x1,y1,dashboard/dash_button_large_bg)"		1="image_scale(x0,y0,x1,y1,dashboard/dash_button_large_glyph_tutorial)" }	}
		TutorialButtonStyle:hover		{ bgcolor=none render_bg	{ 0="image_scale(x0,y0,x1,y1,dashboard/dash_button_large_bg)"		1="image_scale(x0,y0,x1,y1,dashboard/dash_button_large_glyph_tutorial)" }	}
		TutorialButtonStyle:active		{ bgcolor=none render_bg	{ 0="image_scale(x0,y0,x1,y1,dashboard/dash_button_large_bg)"		1="image_scale(x0,y0,x1,y1,dashboard/dash_button_large_glyph_tutorial)" }	}
		TutorialButtonStyle:selected	{ bgcolor=none render_bg	{ 0="image_scale(x0,y0,x1,y1,dashboard/dash_button_large_selected)" 1="image_scale(x0,y0,x1,y1,dashboard/dash_button_large_glyph_tutorial)" }	}
		...
		FindMatchButtonStyle			{ font=Arial18Thick textcolor=dullwhite bgcolor=none render_bg	{ 0="image_scale(x0,y0,x1,y1,dashboard/dash_button_positive_bg)"	}	}
		FindMatchButtonStyle:hover		{ font=Arial18Thick textcolor=white bgcolor=none render_bg		{ 0="image_scale(x0,y0,x1,y1,dashboard/dash_button_positive_bg)"	}	}
		FindMatchButtonStyle:active		{ font=Arial18Thick textcolor=dullwhite bgcolor=none render_bg	{ 0="image_scale(x0,y0,x1,y1,dashboard/dash_button_positive_bg)"	}	}
		
		PingPartyButtonStyle			{ font=Arial18Thick textcolor=dullwhite bgcolor=none render_bg	{ 0="image_scale(x0,y0,x1,y1,dashboard/dash_button_ancillary_bg)"	}	}
		PingPartyButtonStyle:hover		{ font=Arial18Thick textcolor=white bgcolor=none render_bg		{ 0="image_scale(x0,y0,x1,y1,dashboard/dash_button_ancillary_bg)"	}	}
		PingPartyButtonStyle:active		{ font=Arial18Thick textcolor=dullwhite bgcolor=none render_bg	{ 0="image_scale(x0,y0,x1,y1,dashboard/dash_button_ancillary_bg)"	}	}		
	}	
