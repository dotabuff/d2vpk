"Resource/UI/HUD_Shop.res"
{
	...
	styles
	{
		...
		CloseButton
		{
			...
			render_bg
			{
				0="image_scale( x0, y0, x1, y1, hud/shop/button_close )"
			}
		}
		...
		SearchText
		{
			...
			render_bg 
			{
				0="image_scale( x0, y0, x1, y1, hud/shop/shop_search_field_on )"
			}
		} 
		...
		SearchOverlay
		{
			...
			render_bg 
			{
				0="image_scale( x0, y0, x1, y1, hud/shop/shop_search_field_off )"
			}
		}
