"Resource/UI/DOTADashboardBasePanel.res"
{
	...
	styles
	{
		...
		QuitButtonStyle
		{
			...
			render_bg
			{			
				0="image_scale( x0, y0, x1, y1, dashboard/dash_button_quit_normal )"
			}
		}
		QuitButtonStyle:hover
		{
			...
			render_bg
			{			
				0="image_scale( x0, y0, x1, y1, dashboard/dash_button_quit_over )"
			}	
		}
		...
		QuitButtonStyle:active
		{
			...
			render_bg
			{			
				0="image_scale( x0, y0, x1, y1, dashboard/dash_button_quit_down )"
			}		
		}
		...
		SettingsButtonStyle
		{
			...
			render_bg
			{			
				0="image_scale( x0, y0, x1, y1, dashboard/dash_button_settings_normal )"
			}
		}
		SettingsButtonStyle:hover
		{
			...
			render_bg
			{			
				0="image_scale( x0, y0, x1, y1, dashboard/dash_button_settings_over )"
			}	
		}
		SettingsButtonStyle:active
		{
			...
			render_bg
			{			
				0="image_scale( x0, y0, x1, y1, dashboard/dash_button_settings_down )"
			}		
		}
		...
		MaximizeButtonStyle
		{
			...
			render_bg
			{			
				0="image_scale( x0, y0, x1, y1, dashboard/dash_button_window_normal )"
			}
		}
		MaximizeButtonStyle:hover
		{
			...
			render_bg
			{			
				0="image_scale( x0, y0, x1, y1, dashboard/dash_button_window_over )"
			}	
		}
		MaximizeButtonStyle:active
		{
			...
			render_bg
			{			
				0="image_scale( x0, y0, x1, y1, dashboard/dash_button_window_down )"
			}		
		}
		...
		DashboardSectionButton
		{
			...
			render_bg
			{			
				0="image_scale( x0, y0, x1, y1, dashboard/dash_tab_normal )"
			}
		}
		DashboardSectionButton:hover
		{
			...
			render_bg
			{			
				0="image_scale( x0, y0, x1, y1, dashboard/dash_tab_hover )"
			}
		}
		...
		DashboardSectionButton:selected
		{
			...
			render_bg
			{			
				0="image_scale( x0, y0, x1, y1, dashboard/dash_tab_selected )"
			}		
		}
		...
		DashboardSectionButton:active
		{
			...
			render_bg
			{			
				0="image_scale( x0, y0, x1, y1, dashboard/dash_tab_flash )"
			}			
		}
