	...
	"styles"
	{
		...
		DashboardPlayInnerBackground
		{
			render_bg
			{
				...
				0="image_scalable( x0, y0, x1, y1, dashboard/dash_background_generic_inset_magic, 16, 16, 16, 16, 1, 1 )"
			}
		}
		Button
		{
		...
		PartySlotStyle
		{
			render_bg
			{
				0="image_scale( x0, y0, x1, y1, dashboard/dash_drop_well )"
				//0="roundedfill( x0, y0, x1, y1, 6, White172 )"
			}
		}
		
		GreyButtonStyle				{ font=Arial18Thick textcolor=dullwhite bgcolor=none render_bg	{ 0="image_scale(x0,y0,x1,y1,dashboard/dash_button_ancillary_bg)"	}	}
		GreyButtonStyle:hover		{ font=Arial18Thick textcolor=white bgcolor=none render_bg		{ 0="image_scale(x0,y0,x1,y1,dashboard/dash_button_ancillary_bg)"	}	}
		GreyButtonStyle:active		{ font=Arial18Thick textcolor=dullwhite bgcolor=none render_bg	{ 0="image_scale(x0,y0,x1,y1,dashboard/dash_button_ancillary_bg)"	}	}
		
		GreyButton14Style				{ font=Arial14Thick textcolor=dullwhite bgcolor=none render_bg	{ 0="image_scale(x0,y0,x1,y1,dashboard/dash_button_ancillary_bg)"	}	}
		GreyButton14Style:hover		{ font=Arial14Thick textcolor=white bgcolor=none render_bg		{ 0="image_scale(x0,y0,x1,y1,dashboard/dash_button_ancillary_bg)"	}	}
		GreyButton14Style:active		{ font=Arial14Thick textcolor=dullwhite bgcolor=none render_bg	{ 0="image_scale(x0,y0,x1,y1,dashboard/dash_button_ancillary_bg)"	}	}
		...
		ScrollBarButton.up
		{
			...
			render_bg
			{
				1="image_scale( x0, y0, x1, y1, scroll_up )"
			}	
		}
		...
		ScrollBarButton.down
		{
			...
			render_bg
			{
				1="image_scale( x0, y0, x1, y1, scroll_down )"
			}
		}
		...
		ScrollBarHandle  //vertical scrollbar thumb
		{
			...
			render_bg
			{
				1="image_scalable( x0, y0, x1, y1, scroll_box, 0, 16, 0, 6, 1, 1 )"
			}
		}
		...
		ScrollBarSlider // gutter
		{
			...
			render_bg
			{
				1="image_scale( x0, y0, x1, y1, scroll_line )"
			}
		}
		...
		GreyNoiseBackground
		{
			render_bg
			{
				0="image_tiled( x0, y0, x1, y1, dashboard/dash_background_generic_tiler )"
			}
		}				
		...
		ComboBox
		{
			...
			render_bg
			{     
				0="image_scalable( x0, y0, x1, y1, dashboard/dash_button_drop_bg, 8, 8, 8, 8, 1, 1 )"
			}
		}
